...
<head>
    ...
    <!-- Bootstrap Css -->
    <link href="{{ asset('skoteassets/css/bootstrap.min.css')}}" id="bootstrap-style" rel="stylesheet"
        type="text/css" />
    <!-- Icons Css -->
...
<body data-sidebar="dark" data-layout-mode="light">
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                            ...
                            <img class="rounded-circle header-profile-user"
                                src="{{ url('foto/', auth()->user()->foto) }}" alt="Header Avatar" />
            ...
            <div data-simplebar class="h-100">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            <a href="/carousel" class="waves-effect">
                                <i class="bx bx-chat"></i>
                        ...
                        <li>
                            <a href="/breaking" class="waves-effect">
                                <i class="bx bx-chat"></i>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ url('admin/postsStore') }}" method="POST"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-12">
                                                <div>
                                                    <input class="form-control form-control-lg" id="gambar"
    ...
    <div class="right-bar">
        <div data-simplebar class="h-100">
            ...
            <div class="p-4">
                <div class="mb-2">
                    <img src="{{ asset('skoteassets/images/layouts/layout-1.jpg')}}" class="img-thumbnail"
                        alt="layout images" />
                </div>
                ...
                <div class="mb-2">
                    <img src="{{ asset('skoteassets/images/layouts/layout-2.jpg')}}" class="img-thumbnail"
                        alt="layout images" />
                </div>
                <div class="form-check form-switch mb-3">
